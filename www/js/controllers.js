angular.module('starter.controllers', [])
  ...
  .controller('DashCtrl', function ($scope, accountService, $ionicScrollDelegate, $location, $stateParams, $state, localStorageService, $timeout) {
